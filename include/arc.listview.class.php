...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<a class=\"page_item\">共 <strong>1</strong>页<strong>".$this->TotalResult."</strong>条记录</a>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<a class=\"page_item\">共 <strong>0</strong>页<strong>".$this->TotalResult."</strong>条记录</a>\r\n";
        }
        $purl = $this->GetCurUrl();
        $maininfo = "<a class=\"page_item\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</a>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class=\"page_item\" href='".str_replace("{page}",$prepagenum,$tnamerule)."'>上一页</a>\r\n";
            $indexpage="<a class=\"page_item\" href='".str_replace("{page}",1,$tnamerule)."'>首页</a>\r\n";
        }
        else
        {
            $indexpage="<a class=\"page_item\">首页</a>\r\n";
        }

        //下一页,未页的链接
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a class=\"page_item\" href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>下一页</a>\r\n";
            $endpage="<a class=\"page_item\" href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a>\r\n";
        }
        else
        {
            $endpage="<a class=\"page_item\">末页</a>\r\n";
        }
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<a class=\"page_item_current\">$j</a>\r\n";
            }
            else
            {
                $listdd.="<a class=\"page_item\" href='".str_replace("{page}",$j,$tnamerule)."'>".$j."</a>\r\n";
            }
        }
        $plist = '';
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            return "<a class=\"page_item\">共 1 页/".$this->TotalResult." 条记录</a>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<a class=\"page_item\">共 0 页/".$this->TotalResult." 条记录</a>\r\n";
        }
        $maininfo = "<a class=\"page_item\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</a>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class=\"page_item\" href='".$purl."PageNo=$prepagenum'>上一页</a>\r\n";
            $indexpage="<a class=\"page_item\" href='".$purl."PageNo=1'>首页</a>\r\n";
        }
        else
        {
            $indexpage="<a class=\"page_item\">首页</a>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a class=\"page_item\" href='".$purl."PageNo=$nextpagenum'>下一页</a>\r\n";
            $endpage="<a class=\"page_item\" href='".$purl."PageNo=$totalpage'>末页</a>\r\n";
        }
        else
        {
            $endpage="<a class=\"page_item\">末页</a>\r\n";
        ...
        for($j;$j<=$total_list;$j++)
        {
            ...
            {
                $listdd.="<a class=\"page_item\" href='".$purl."PageNo=$j'>".$j."</a>\r\n";
            }
        }
